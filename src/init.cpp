...
static bool fFeeEstimatesInitialized = true;
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/Gleecs/GleecBTC-FullNode-Win-Mac-Linux>";
    const std::string URL_WEBSITE = "<https://gleecbtc.com>";
